                ...
                case EngineType.RSDKv5:
                    ...
                    for (int a = 0; a < Animations.Count; a++)
                    {
                        ...
                        for (int i = 0; i < Animations[a].Frames.Count; i++)
                        {
                            ...
                            {
                                frame.HitBoxes.Add(new RSDKv5.Animation.AnimationEntry.Frame.HitBox());
                                frame.HitBoxes[h].Height = Animations[a].Frames[i].HitBoxes[h].Height;
                                frame.HitBoxes[h].Width = Animations[a].Frames[i].HitBoxes[h].Width;
                                frame.HitBoxes[h].X = Animations[a].Frames[i].HitBoxes[h].X;
                                frame.HitBoxes[h].Y = Animations[a].Frames[i].HitBoxes[h].Y;
                            }
